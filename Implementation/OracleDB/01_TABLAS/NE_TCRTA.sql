...
create TABLE FS_AUWEB_US.NE_TCRTA
(
...
COMMENT ON COLUMN  FS_AUWEB_US.NE_TCRTA.CRTA_DESCRI      IS 'Descripcion funcional de codigo de respuesta. ';
COMMENT ON COLUMN  FS_AUWEB_US.NE_TCRTA.CRTA_USUA        IS 'Usuario que crea el codigo de respuesta ';
COMMENT ON COLUMN  FS_AUWEB_US.NE_TCRTA.CRTA_FECCRE      IS 'Fecha de creacion del codigo de respuesta';
COMMENT ON COLUMN  FS_AUWEB_US.NE_TCRTA.CRTA_IDIOMA      IS 'Códigos de países e idiomas I18N';
